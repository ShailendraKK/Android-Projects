package com.shailendra.photonotesgallery.utils;
...
import com.shailendra.photonotesgallery.media.MediaNameSorter;
import com.shailendra.photonotesgallery.media.MediaSizeSorter;
import com.shailendra.photonotesgallery.media.MediaTakenSorter;
...
public abstract class PrefUtils {
    ...
    public static Comparator<MediaEntry> getSortComparator(Context context, @MediaAdapter.SortMode int mode) {
        switch (mode) {
            ...
            case MediaAdapter.SORT_SIZE_DESC:
                return new MediaSizeSorter();
            default:
